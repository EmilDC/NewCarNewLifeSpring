...
public class EstadoTaller {
	...
	@Pattern(regexp = "[^!\"#$%&'()*+,-./:;<=>?@^_`{|}~]+", message = "El nombre del estado del taller no puede contener un caracter especial")
	@Pattern(regexp = "[^0-9]+", message = "El nombre del estado del taller no puede contener un número")
